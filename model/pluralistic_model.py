...
class Pluralistic(BaseModel):
    ...
    def backward_G(self):
        ...
        self.loss_l1_g = self.L1loss(self.img_truth, self.img_g) * self.opt.lambda_l1
        ...
        self.loss_ssim = self.ssim(self.img_g, self.img_truth) * self.opt.lambda_ssim
        totalG_loss = self.loss_l1_g + self.loss_per + self.loss_sty + self.loss_ad_g + self.loss_ssim
